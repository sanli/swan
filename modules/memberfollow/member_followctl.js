//#!本文件由share.js自动产生, 命令行为: node share.js gen member_follow
/**
 * member_followHTTP入口模块, 需要在主文件中添加map
 * var member_follow = require('./routes/member_follow').bindurl(app);
 */
'use strict';
var member_followdb = require('./member_followdb.js')
    // base function
...
// 模块相关的全局属性
const module_name = 'member_follow', module_desc = '意中人关系';
...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/member_follow.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/member_follow/create', exports.create);
    share.bindurl(app, '/member_follow/update', exports.update);
    share.bindurl(app, '/member_follow/list', exports.list);

    share.bindurl(app, '/member_follow/get', exports.get);
    share.bindurl(app, '/member_follow/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/member_follow/delete', exports.delete);
    share.bindurl(app, '/member_follow/count', exports.count);


    share.bindurl(app, '/member_follow/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
...
exports.page = function(req, res){
    res.render('member_followpage.html', {
        conf : conf,
...
exports.create = function(req, res){
    ...
    member_followdb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    member_followdb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    member_followdb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    member_followdb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.get = function(req, res){
    ...
    member_followdb.findById(arg._id, function(err, doc){
...
exports.retriveByCond = function(req, res){ 
    ...
    member_followdb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    member_followdb.delete(arg._id , function(err, doc){
...
exports.dlg = function(req, res){
    ...
    res.render( 'member_follow/' + arg.dlgfile, {
        user : req.session.user,
        commons : require('../../routes/commons.js'),
    });
};
