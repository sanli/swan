//#!本文件由share.js自动产生, 命令行为: node share.js gen member_log
/**
 * member_logHTTP入口模块, 需要在主文件中添加map
 * var member_log = require('./routes/member_log').bindurl(app);
 */
'use strict';
var member_logdb = require('./member_logdb.js')
    // base function
...
// 模块相关的全局属性
const module_name = 'member_log', module_desc = '会员操作日志';
...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/member_log.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/member_log/create', exports.create);
    share.bindurl(app, '/member_log/update', exports.update);
    share.bindurl(app, '/member_log/list', exports.list);

    share.bindurl(app, '/member_log/get', exports.get);
    share.bindurl(app, '/member_log/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/member_log/delete', exports.delete);
    share.bindurl(app, '/member_log/count', exports.count);
...
exports.page = function(req, res){
    res.render('member_logpage.html', {
        conf : conf,
...
exports.create = function(req, res){
    ...
    member_logdb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    member_logdb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    member_logdb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    member_logdb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.get = function(req, res){
    ...
    member_logdb.findById(arg._id, function(err, doc){
...
exports.retriveByCond = function(req, res){ 
    ...
    member_logdb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    member_logdb.delete(arg._id , function(err, doc){
...
exports.dlg = function(req, res){
    ...
    res.render( 'member_log/' + arg.dlgfile, {
        user : req.session.user,
        commons : require('../../routes/commons.js'),
    });
};
