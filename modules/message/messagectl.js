//#!本文件由share.js自动产生, 命令行为: node share.js gen message
/**
 * messageHTTP入口模块, 需要在主文件中添加map
 * var message = require('./routes/message').bindurl(app);
 */
'use strict';
...
// 模块相关的全局属性
const module_name = 'message', module_desc = '站内信';
...
exports.bindurl=function(app){
    ...
    //动态文件
    share.bindurl(app, '/message.html', { outType : 'page'}, exports.page);
    share.bindurl(app, '/message/create', exports.create);
    share.bindurl(app, '/message/update', exports.update);
    share.bindurl(app, '/message/list', exports.list);

    share.bindurl(app, '/message/get', exports.get);
    share.bindurl(app, '/message/retriveByCond', exports.retriveByCond);
    share.bindurl(app, '/message/delete', exports.delete);
    share.bindurl(app, '/message/count', exports.count);


    share.bindurl(app, '/message/dlg/:dlgfile', { outType : 'page'}, exports.dlg);
    //TODO: 扩展的API加在下面
    // ...
}
...
exports.create = function(req, res){
    ...
    messagedb.create(arg.data, function(err, newDoc){
...
exports.update = function(req, res){
    ...
    var data = arg.data;
    delete data._id;
    messagedb.update( arg._id , data , function(err, cnt){
        if(err) {
            console.log(err);
...
exports.list = function(req, res){
    ...
    messagedb.list(arg.cond, arg.sort, page, function(err, docs){
...
exports.count = function(req, res){
    ...
    share.searchCondExp(arg.cond);
    share.fillUserDataRule(arg.cond, req);
    messagedb.count(arg.cond, function(err, count){
        if(err) return share.rt(false, err.message, res);
...
exports.retriveByCond = function(req, res){ 
    ...
    messagedb.findByCond(arg.cond, function(err, doc){
        if(err) return share.rt(false, `查询${module_desc}出错:` + err.message, res);
...
exports.delete = function(req, res){
    ...
    messagedb.delete(arg._id , function(err, doc){
...
exports.dlg = function(req, res){
    ...
    res.render( 'message/' + arg.dlgfile, {
        user : req.session.user,
        commons : require('../../routes/commons.js'),
    });
};
